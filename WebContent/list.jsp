	...
	<table border="1">
		...
		<c:choose>
			...
			<tr>
				...
				<c:choose>
					<c:when test="${param.start == null }"><!-- 사용자가 페이지에 처음 접속 -->
				...
				<c:choose>
					...
					${start } / ${pc.totalPage }
					<button type="button" onclick="location.href='regFormjsp'">등록</button>
				</td>
			</tr>	
	</table>
</body>
